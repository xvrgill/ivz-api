...
class AirTablePostSchema(Schema):
    ...
    images = fields.List(fields.Dict(), data_key="All images")
    status = fields.List(fields.Str, required=False, data_key="Status")
    us_web_lauch_date = fields.Str(data_key="US Web launch date")
    social_date_1 = fields.Str(required=False, data_key="Social Date #1")
    social_date_2 = fields.Str(data_key="Social Date #2")
    social_date_3 = fields.Str(data_key="Social Date #3")
    social_date_4 = fields.Str(data_key="Social Date #4")
    social_date_5 = fields.Str(data_key="Social Date #5")
    social_date_6 = fields.Str(data_key="Social Date #6")
    social_date_7 = fields.Str(data_key="Social Date #7")
    social_date_8 = fields.Str(data_key="Social Date #8")
